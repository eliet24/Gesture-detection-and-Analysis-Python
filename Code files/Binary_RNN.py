...
data_save_path_x = "D:/FinalProject/RNN/binary_rnn_data/binary_Rnn_Sub_Data_X_Ver2.npy"
data_save_path_y = "D:/FinalProject/RNN/binary_rnn_data/binary_Rnn_Sub_Data_Y_Ver2.npy"
...
model.add(Dense(2, activation="softmax"))   # TODO: num of classes + try sigmoid
model.summary()
...
callbacks = [earlystop]
history = model.fit(x=X_train, y=y_train, epochs=30, batch_size=4, shuffle=True, validation_split=0.2, callbacks=callbacks)
y_pred = model.predict(X_test)
y_pred = np.argmax(y_pred, axis=1)
y_test = np.argmax(y_test, axis=1)
print(classification_report(y_test, y_pred))
print(confusion_matrix(y_test, y_pred))
model.save('binary_Rnn_Sub_V3.h5')
